...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  # by nemělo umožňovat úpravu atributu admin prostřednictvím webu
  ...
  # by mělo umožnit úpravu atributu admin prostřednictvím webu
  test 'should allow the admin attribute to be edited via the web' do
    log_in_as(@user)
    assert @user.admin?
